...
const svg = `<svg width="1180" height="290" viewBox="0 0 1180 290" xmlns="http://www.w3.org/2000/svg">
  ...
  <style>
    ...
    .icon-box { fill: #181614; }
    .icon-text { fill: #F2F0EB; font-family: system-ui, sans-serif; font-weight: 800; }
    .dot-accent { fill: #181614; }
    .arrow-icon { stroke: #181614; }
    ...
    @media (prefers-color-scheme: dark) {
      ...
      .icon-box { fill: #F2F0EB; }
      .icon-text { fill: #181614; }
      .dot-accent { fill: #F2F0EB; }
      .arrow-icon { stroke: #F2F0EB; }
    }
